...
$(function () {
  ...
  $('#mobile').on('blur', account_number); //这个是账号的
  ...
  function submitForm(evt) {
    ...
    var bba = document.querySelector('.setPassword').nextSibling.nextSibling.nextSibling.nextSibling.nextSibling.nextSibling;
    ...
    if (bbs.className == 'Act_sooob') {} else if (bba.className == 'Act_sooob') {} else if (aaa.className == 'Rdm_sooob') {} else if (bbb.className == 'Pwd_sooob') {} else {
      $('.disagree').on('click', submission);
    }
  } //拿cook存储
