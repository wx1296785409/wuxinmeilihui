$(function () {
    ...
    $('.buy_now_btn').click(function(){
        //品牌
        var brand = $(this).parents('.product_info').children('.product_title').html()
        //商品名称
        var name = $(this).parents('.product_info').children('.product_name').children('h1').html()
        //颜色
        var colour = $(this).parents('.product_info').children('.product_choose_color').children('.product_choose_title').children('span').html()
        //尺码
        var size = $(this).parents('.product_info').children('.product_choose_size').children('#product_choose_size_ul').children('li').children('.huar').html()
        //价格
        var price = $(this).parents('.product_info').children('.product_price_box').children('.product_price').children('#productRMB').html()
        //个数
        var number = $(this).parents('.product_info').children('.product_choose').children('.number_choose').children('.quantity_number').children('#quantity').val()
        //图片
